...
function Checkout() {
    ...
    useEffect(()=>{
       async function fetch(){
        axios.get('https://mahesh-prepbytes-server.onrender.com/getcourse')
    ...
    let email=localStorage.getItem('email')
        let response=await axios.post("https://mahesh-prepbytes-server.onrender.com/checkout",{"amount":2500*100})
...
<div className='flex'><p>Sub  Total:</p><p  style={{color:"orange", fontSize:"larger"}}>{data&&data.price}2500</p></div>
<div><div>
    <div><p style={{color:"orange", fontSize:"larger ", textAlign:"left"}}>Appy Coupon</p></div>
    <div className='flex'><p>Total Amount:</p><p>2500</p></div>
